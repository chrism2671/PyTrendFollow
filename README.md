...
1. Install requirements:
    ...
    * To compile the binary version of `arch`, you will need the development lirbary for your
      version of Python. e.g., for Python 3.5 on Ubuntu, use `sudo apt-get install libpython3.5-dev`.
