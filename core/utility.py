...
def norm_vol(df):
    """Arbitrarily normalize the volatility of a series. Useful for where different instruments have different
    price volatilities but we still want to feed them into the same regressor
